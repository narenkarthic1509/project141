...
function gotPoses(results){
  ...
  if(results.length > 0){
    ...
    score_of_the_rightwrist = results[0].pose.keypoints[10].score;

    console.log("right wrist x : " + rightWristX + " y : " + rightWristY);
    console.log("score of the right wrist is : " + score_of_the_rightwrist);
  }
}
...
function draw(){
  ...
  if(score_of_the_rightwrist > 0.2){
    fill("#9345EE");
    stroke("#9345EE");
